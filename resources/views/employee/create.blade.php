               ...
               <div class="card-body">
                   ...
                   <form action="/employee" method="POST">
                       ...
                       <div class="mb-3">
                           ...
                           <input type="number" class="form-control @error('employee_code') is-invalid @enderror" name="employee_code"
                               id="employee_code" value="{{ old('employee_code') }}">
                       ...
                       <div class="mb-3">
                           ...
                           <input type="number" class="form-control @error('pos_code') is-invalid @enderror"
                               name="pos_code" id="pos_code" value="{{ old('pos_code') }}">
                       ...
                       <div class="mb-3">
                           ...
                           <select name="division_id" class="form-control @error('division_id') is-invalid @enderror"
                               ...
                               @foreach ($divisions as $division)
                                   <option value="{{ $division->id }}" @selected(old('division_id') == $division->id)>{{ $division->division }}</option>
                               @endforeach
                           </select>
                           @error('division_id')
                               <div class="form-text text-danger">{{ $message }}</div>
